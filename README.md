...
<div align="center">
  ...
  <p>
    <a href="https://zenn.dev/soichiro_n/books/d58755c84d31a9">ドキュメント</a> |
  </p>
</div>
...
Flunoの学習には、公式ガイドブック **[The Fluno Programming Language](https://zenn.dev/soichiro_n/books/d58755c84d31a9)** を参照してください。
...
### インストール
ソースコードからビルドするか、最新のリリースをダウンロードして使ってください。
...
現在は開発途中です。コア機能の実装が進んでいますが、仕様変更の可能性があります。
