...
impl ErrorCode {
    ...
    pub fn category(&self) -> &'static str {
        match self {
            ...
            | ErrorCode::R1006
            | ErrorCode::R1007
            | ErrorCode::R1008 => "Runtime",

            ErrorCode::T2001
            | ErrorCode::T2002
            | ErrorCode::T2003
            | ErrorCode::T2004
            | ErrorCode::T2005 => "Type",

            ErrorCode::P3001 | ErrorCode::P3002 | ErrorCode::P3003 | ErrorCode::P3004 => "Parse",

            ErrorCode::I4001 | ErrorCode::I4002 | ErrorCode::I4003 | ErrorCode::I4004 => "I/O",
